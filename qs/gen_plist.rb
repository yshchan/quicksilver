...
unless watchlist.empty?
	...
	if list.any?
		plist = {"Label"=>"com.yashwantc.quicksilver.plist", "OnDemand"=>true, "EnableGlobbing"=>true, "KeepAlive"=>true, "ProgramArguments"=>["bash","~/.quicksilver/qs/qs.sh","--run"],"WatchPaths"=>list}
		plist.to_plist
